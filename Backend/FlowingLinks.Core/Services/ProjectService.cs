...
namespace FlowingLinks.Core.Services
{
    ...
    {
        public ProjectService(FlowingLinksDbContext dbContext) =>
        ...
        public async Task Save(ProjectDto projectDto, int userId)
        {
            ...
            if (projectDto.Id == 0)
            {
                ...
                if (existingProject != null)
                    throw new FlowingLinksException($"Project '{projectDto.Name}' already exists for this user.");
            ...
            else
            {
                ...
                if (project == null)
                    throw new FlowingLinksException($"Project with ID {projectDto.Id} not found.");
